...
总而言之, 大家都是开发者, 请提出 _你自己_ _希望收到的_ bug.
...
所有的贡献 _将被_ 认定为遵循 Apache 2.0 开源协议.

如果你已经认真阅读了本指南并同意本指南，请使用我们的 [模板](https://github.com/wequick/Small/blob/master/issue模板.md) 来创建issue。
