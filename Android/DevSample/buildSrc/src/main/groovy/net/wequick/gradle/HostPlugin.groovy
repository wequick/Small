...
class HostPlugin extends BasePlugin<RootExtension> {

    @Override
    protected Class<RootExtension> getExtensionClass() {
        return HostExtension.class
    }
    ...
    protected void configureProject() {
        ...
        def SMALL_LIBS = "smallLibs"

        project.afterEvaluate {
            def android = AndroidPluginUtils.getAndroid(project)

            // Configure libs dir
            def sourceSet = android.sourceSets.main
...
//                if (rootSmall.smallBindingProject != null) {
//                    project.dependencies.add('implementation', rootSmall.smallBindingProject)
//                } else {
//                    project.dependencies.add('implementation', "${SMALL_BINDING_AAR_PREFIX}$rootSmall.bindingAarVersion")
//                }
//            }
        }
    }
